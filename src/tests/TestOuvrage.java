...
public class TestOuvrage {
    ...
    public void testOuvrages() {
        ...
        Ouvrage livre3 = new Ouvrage("Musique du hasard", new Auteur("Paul", "Auster", new Pays("USA", "États-Unis")), Ouvrage.Format.PAPIER, LocalDate.now(), 5);
        ...
        Ouvrage livre4 = new Ouvrage("Test", new Auteur("A", "B", new Pays("USA", "États-Unis")), Ouvrage.Format.PAPIER, LocalDate.now(), 5);

        System.out.println("\n-----Tests de la  méthode equals()-----------");
        //Deux ouvrages égaux
        Ouvrage livre5 = new Ouvrage("Test", new Auteur("A", "B", new Pays("USA", "États-Unis")), Ouvrage.Format.PAPIER, null, 5);
        Ouvrage livre6 = new Ouvrage("Test", new Auteur("A", "B", new Pays("USA", "États-Unis")), Ouvrage.Format.PAPIER, LocalDate.now(), 10);
        //Un qui ne l'est pas
        Ouvrage livre7 = new Ouvrage("Test", new Auteur("Z", "B", new Pays("USA", "États-Unis")), Ouvrage.Format.PAPIER, LocalDate.now(), 5);
    ...
    private void testTrouver() {
        ...
        List<Ouvrage> resultat = bibliotheque.trouverOuvrages(new Auteur("Albertine", "Tremblay", new Pays("CAN", "Canada")));
        ...
        resultat = bibliotheque.trouverOuvrages(new Auteur("Jacques", "Beaulieu", new Pays("FRA", "France")));
